import { i as j, a as V } from "./index.E2NZU3JX.js";
const y = "data-astro-transition-persist",
  K = ["data-astro-transition", "data-astro-transition-fallback"],
  x = new Set();
function F(t) {
  const e = t.src ? new URL(t.src, location.href).href : t.textContent;
  return x.has(e) ? !0 : (x.add(e), !1);
}
function G(t) {
  for (const e of t.scripts)
    !e.hasAttribute("data-astro-rerun") && F(e) && (e.dataset.astroExec = "");
}
function z(t) {
  const e = document.documentElement,
    n = [...e.attributes].filter(
      ({ name: o }) => (e.removeAttribute(o), K.includes(o))
    );
...
function _(t) {
  t.querySelectorAll("template[shadowrootmode]").forEach((e) => {
    const n = e.getAttribute("shadowrootmode"),
      o = e.parentNode;
    if ((n === "closed" || n === "open") && o instanceof HTMLElement) {
      ...
      r.appendChild(e.content), e.remove(), _(r);
    }
  });
}
const Z = () => {
  ...
  nt = (t, e) => t.getAttribute("props") === e.getAttribute("props"),
  ot = (t) => {
    G(t), z(t), J(t);
    const e = Z();
    Q(t.body, document.body), e();
  },
  rt = "astro:before-preparation",
  st = "astro:after-preparation",
  it = "astro:before-swap",
  at = "astro:after-swap",
  ct = (t) => document.dispatchEvent(new Event(t));
class X extends Event {
  ...
  newDocument;
  signal;
  constructor(e, n, o, r, i, u, a, c, d, l) {
    super(e, n),
      (this.from = o),
      (this.to = r),
      (this.direction = i),
...
class lt extends X {
  ...
  loader;
  constructor(e, n, o, r, i, u, a, c, d, l) {
    super(rt, { cancelable: !0 }, e, n, o, r, i, u, a, c),
      (this.formData = d),
...
async function dt(t, e, n, o, r, i, u, a, c) {
  const d = new lt(t, e, n, o, r, i, window.document, u, a, c);
  return (
    document.dispatchEvent(d) &&
      (await d.loader(),
      d.defaultPrevented ||
        (ct(st), d.navigationType !== "traverse" && R({ scrollX, scrollY }))),
    d
  );
}
...
const R = (t) => {
  ...
  Y = (t, e) => t.pathname === e.pathname && t.search === e.search;
let m, p, v;
const C = (t) => document.dispatchEvent(new Event(t)),
  q = () => C("astro:page-load"),
  mt = () => {
...
let I,
  T = 0;
history.state
  ? ((T = history.state.index),
    scrollTo({ left: history.state.scrollX, top: history.state.scrollY }))
  : k() &&
    (history.replaceState({ index: T, scrollX, scrollY }, ""),
    (history.scrollRestoration = "manual"));
async function ht(t, e) {
  try {
    const n = new Headers(e?.headers);
    for (const [a, c] of Object.entries(j)) n.set(a, c);
    const o = await fetch(t, { ...e, headers: n }),
...
const B = (t, e, n, o, r) => {
  ...
  if (t.href !== location.href && !r)
    if (n.history === "replace") {
      ...
      history.pushState(
        { ...n.state, index: ++T, scrollX: 0, scrollY: 0 },
        "",
        t.href
      );
  if (
...
async function N(t, e, n, o, r) {
  async function i(d) {
    ...
    document.documentElement.setAttribute(S, d);
    const g = document.getAnimations().filter((f) => !s.includes(f) && !l(f));
    return Promise.allSettled(g.map((f) => f.finished));
  }
  const u = async () => {
    ...
    a = document.title,
    c = await ft(t, n.viewTransition, u);
  B(c.to, c.from, e, a, o),
    C(at),
    r === "animate" &&
...
async function U(t, e, n, o, r) {
  const i = pt();
  if (!k() || location.origin !== n.origin) {
  ...
  if (
    ...
    Y(e, n) &&
      !o.formData &&
      ((t !== "back" && n.hash) || (t === "back" && e.hash)))
  ) {
    B(n, e, o, document.title, r), i === m && (m = void 0);
    return;
  }
  const a = await dt(
    e,
  ...
  async function c(s) {
    ...
    if (s.formData) {
      ...
      g.body =
        e !== void 0 &&
        Reflect.get(HTMLFormElement.prototype, "attributes", b).getNamedItem(
          "enctype"
        )?.value === "application/x-www-form-urlencoded"
          ? new URLSearchParams(s.formData)
          : s.formData;
    }
    const f = await ht(h, g);
    if (f === null) {
      s.preventDefault();
      return;
    }
    if (f.redirected) {
      const b = new URL(f.redirected);
      if (b.origin !== s.to.origin) {
        s.preventDefault();
        return;
      }
      const W = s.to.hash;
    ...
    if (
      ((I ??= new DOMParser()),
      (s.newDocument = I.parseFromString(f.html, f.mediaType)),
      s.newDocument.querySelectorAll("noscript").forEach((b) => b.remove()),
  ...
  if ((document.documentElement.setAttribute(P, a.direction), L))
    l.viewTransition = document.startViewTransition(
      async () => await N(a, o, l, r)
    );
  else {
    const s = (async () => {
      await Promise.resolve(), await N(a, o, l, r, $());
    })();
    l.viewTransition = {
      ...
      skipTransition: () => {
        (l.transitionSkipped = !0), document.documentElement.removeAttribute(S);
      },
      types: new Set(),
    };
  }
...
async function O(t, e) {
  await U("forward", v, new URL(t, location.href), e ?? {});
}
function yt(t) {
  if (!k() && t.state) {
    location.reload();
  ...
  const e = history.state,
    n = e.index,
    o = n > T ? "forward" : "back";
  (T = n), U(o, v, new URL(location.href), {}, e);
}
const H = () => {
  history.state &&
...
(L || gt() !== "none") &&
  ...
  document.addEventListener("submit", (t) => {
    ...
    const n = t.submitter,
      o = n && n === A;
    if (((A = null), e.tagName !== "FORM" || t.defaultPrevented || M(e) || o))
      return;
    const r = e,
      i = new FormData(r, n),
